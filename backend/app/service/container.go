...
type IContainerService interface {
	...
	SearchAppWithContainer(req dto.AppSearch) (int64, interface{}, error)
	UninstallApp(req dto.AppManage) error
	UpdateAppEnable(req dto.AppManage) error
	UpdateAppStatus(req dto.AppManage) error
}
