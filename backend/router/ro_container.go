...
func (s *ContainerRouter) InitRouter(Router *gin.RouterGroup) {
	...
	baseApi := v1.ApiGroupApp.BaseApi
	{
		...
		baRouter.POST("/app/search", baseApi.SearchAppManage)
		baRouter.POST("/app/update/enable", baseApi.UpdateAppEnable)
		baRouter.POST("/app/update/status", baseApi.UpdateAppStatus)
		baRouter.POST("/app/uninstall", baseApi.UninstallAppManage)
