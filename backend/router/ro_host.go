...
func (s *HostRouter) InitRouter(Router *gin.RouterGroup) {
	...
	baseApi := v1.ApiGroupApp.BaseApi
	{
		...
		hostRouter.POST("/user/search", baseApi.SearchUserManage)
		hostRouter.POST("/user/update", baseApi.UpdateUserManage)
		hostRouter.POST("/user/delete", baseApi.DeleteUserManage)
